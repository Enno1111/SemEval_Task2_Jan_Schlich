...
Dieses Modell hat weder Temporal- noch User-ID-Features -- dient als
Kontrollgruppe: existiert der seen/unseen- bzw. seen_own_id/seen_unknown-
Gap schon ohne jede Personalisierung, ist er nicht (allein) auf die
Personalisierungs-Mechanismen der anderen Modelle zurueckzufuehren.

Ausfuehren im Ordner 1.2_RegressionBaseline: python group_error_analysis.py
"""
import os
import numpy as np
import pandas as pd
...
def main():
    ...
    # Regression-to-the-mean-Check: wird bei Extremwerten systematisch untertrieben?
    for target in ("valence", "arousal"):
