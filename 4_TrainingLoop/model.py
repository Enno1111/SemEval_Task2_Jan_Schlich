...
def run_epoch(model, loader, optimizer, scheduler, criterion, train=True):
    ...
    with context:
        for batch in loader:
            ...
            loss = (VALENCE_LOSS_WEIGHT * criterion(valence_logits, valence_labels)
                    + AROUSAL_LOSS_WEIGHT * criterion(arousal_logits, arousal_labels))
...
def main():
    ...
    if SCHEDULER_TYPE == "linear":
        ...
        raise ValueError(f"Unbekannter SCHEDULER_TYPE: {SCHEDULER_TYPE}")
